    ...
    <div className=" flex flex-col items-center rounded-lg px-1 absolute right-1">
      ...
      {isOpen && (
        <div className="bg-violet-50 absolute top-16 flex flex-col items-center rounded-lg p-2 w-full border border-gray-500 ">
            ...
            <img src={profile} alt="carrito" className="h-6 cursor-pointer hover:scale-110 duration-100 items-center mt-4" />
            </Link>
            <hr className="my-4 border-gray-600"
            style={{ width: "80%", margin: "20px auto" }}/>  </>}
           
            <Link to='/cart'> 
            <img src={carrito} alt="carrito" className={`h-8 cursor-pointer hover:scale-110 duration-100 items-center ${uid}`} />
            </Link>
            <hr
          ...
          </Link>) :  (<p className="cursor-pointer  hover:scale-110 duration-100 font-medium" onClick={logout}>Log out</p>)}
            <hr
            className="my-4 border-gray-600"
            style={{ width: "80%", margin: "20px auto" }}
          />
          ...
          <hr className="my-4 border-gray-600"
            style={{ width: "80%", margin: "20px auto" }}/>
          <Link to='/admin'>
            <img src={admin} alt="admin" className="h-8 hover:scale-110 duration-100 font-medium juce py-1"/>
          </Link>
        </div>
      )}
    </div>
